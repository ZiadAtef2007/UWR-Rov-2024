...
#MAKE THE CORNERS OF THE PICTURE:
...
# ON LEFT CLICK TO MAKE THE DISTRUBTED NETS:
def on_left_click(event):
    ...
    draw.ellipse([(x-15, y-15), (x+15, y+15)], fill=None, outline="blue", width=5)
    ...
    click_counter_label.config(text=f"Location Q1: \n"
                                 f"Illegally Sized Nets: {bottom_left_right_clicks}\n" 
                                 f"Disrupted Nets: {bottom_left_left_clicks}\n"
                                 f"\n"
                                 f"Location Q2: \n"
                                 f"Illegally Sized Nets: {top_left_right_clicks}\n" 
                                 f"Disrupted Nets: {top_left_left_clicks}\n"
                                 f"\n"
                                 f"Location Q3: \n"
                                 f"Illegally Sized Nets: {top_right_right_clicks}\n" 
                                 f"Disrupted Nets: {top_right_left_clicks}\n"
                                 f"\n"
                                 f"Location Q4: \n"
                                 f"Illegally Sized Nets: {bottom_right_right_clicks}\n" 
                                 f"Disrupted Nets: {bottom_right_left_clicks}\n"
                                 f"\n")
#------------------------------------------
...
# ON RIGHT CLICK TO MAKE THE ILLEGALLY SIZED NETS:
def on_right_click(event):
    ...
    draw.line([(x-15, y-15), (x+15, y+15)], fill="red", width=5)  # top-left to bottom-right
    draw.line([(x+15, y-15), (x-15, y+15)], fill="red", width=5)  # top-right to bottom-left
...
click_counter_label = tk.Label(root, text="Location Q1: \n"
                                         "Illegally Sized Nets: 0 \n"
                                         "Disrupted Nets: 0 \n"
                                         "\n"
                                         "Location Q2: \n"
                                         "Illegally Sized Nets: 0 \n"
...
# Print the final counter values to the terminal:
print(f"Total Illegal Sized Nets: {left_clicks}\n"
      f"Total Distrubted Nets: {right_clicks}\n"
      f"\n"
      f"Location Q1 \n"
      f"Illegally Sized Nets: {bottom_left_right_clicks}\n" 
      f"Disrupted Nets: {bottom_left_left_clicks}\n"
