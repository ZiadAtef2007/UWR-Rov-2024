...
def on_left_click(event):
    ...
    # Update the click counters and quarter label
    click_counter_label.config(text=f"Left clicks: {left_clicks}, Right clicks: {right_clicks}, Quarter: {quarter}")
...
# Create a label to display the click counters and quarter
click_counter_label = tk.Label(root, text="Left clicks: 0, Right clicks: 0, Quarter: ")
